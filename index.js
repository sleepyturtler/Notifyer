...
// Notifyer's bell-icon logo, as a single vector source (SVG data URI) used
// everywhere — favicon, on-page logo, and TikTok's Basic Info app icon are all
// rendered from this exact same shape, so there's no way for them to drift out
// of sync the way two separately-exported PNGs previously did (app review
// flagged that mismatch). SVG scales crisply to any size, unlike a raster
// image, so favicon-small and app-icon-large (1024x1024, exported separately
// for the TikTok upload since app stores require a raster file) both stay
// sharp — a raster favicon upscaled to 1024 would have looked pixelated, and
// a 1024px raster inlined here would have bloated every page load for nothing,
// since it only ever displays at 36px on the page.
const NOTIFYER_LOGO_URI = 'data:image/svg+xml;base64,';
...
<link rel="icon" type="image/svg+xml" href="${NOTIFYER_LOGO_URI}">
